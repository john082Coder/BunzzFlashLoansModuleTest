...
import { getFlashLenderContract, getFlashBorrowerContract, getFlashMinterContract, flashBorrow, approveRepayment, flashBorrowAndReenter, flashBorrowAndSteal } from '../contracts/utils'
...
const Creator = () => {
    ...
    const flashBorrowerContract = getFlashBorrowerContract(bunzz);
